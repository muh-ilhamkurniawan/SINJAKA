...
if(isset($_POST['hapussemua'])){
    $hapus = "DELETE FROM departure_kroya";
...
if(isset($_GET["cari"])){
    ...
    $search = "SELECT * FROM departure_kroya 
           WHERE  no_ka LIKE '%".$daftardata."%' OR
            ...
            $search = "SELECT * FROM departure_kroya ORDER BY kroya_berangkat";		
        }
?>
<!DOCTYPE html>
        <html lang="en">
        ...
        <head>
            ...
            <title>Data Keberangkatan Stasiun Kroya</title>
            <!-- import bootstrap  -->
        ...
        <body>
            ...
            <div class="container col-lg-12">
                ...
                <h3 class="alert alert-success text-center" role="alert">
                    Database departure_kroya KAI DAOP 5
                </h3>
                <br>
                        ...
                        <table class="table">
                            <thead class="thead-dark">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Kroya Datang</th>
                                    <th scope="col">Kroya Berangkat</th>
                            ...
                            <tbody>
                                <?php
                                        ...
                                        $select         = mysqli_query($koneksi, "SELECT * FROM departure_kroya ORDER BY kroya_berangkat LIMIT 5");
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['kroya_datang']; ?></td>
                                    <td><?php echo $data['kroya_berangkat']; ?></td>
