...
<body class="operator">
    ...
    <div>
        ...
        $select         = mysqli_query($koneksi, "SELECT * FROM departure_kroya ORDER BY kroya_berangkat");
        ...
        ?>
            ...
            <!-- menampilkan data dengan menggunakan array  -->
                ...
                <td width="10%"><?php echo $data['kroya_datang']; ?></td>
                <td width="10%"><?php echo $data['kroya_berangkat']; ?></td>
