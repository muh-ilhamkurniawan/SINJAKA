...
$update = "UPDATE departure_kutoarjo SET
           nomor = '$no',
           no_ka = '$no_ka',
           nama_ka = '$nama_ka',
           relasi = '$relasi',
           ...
           jumlah = '$jumlah',
           purwokerto_datang = '$purwokerto_datang',
           purwokerto_berangkat = '$purwokerto_berangkat',
...
$row = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM departure_kutoarjo WHERE id = '$id'"));
if($row['no_ka'] != ""){
?>
<!doctype html>
<html lang="en">
